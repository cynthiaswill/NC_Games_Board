    ...
    describe("GET /api/reviews", () => {
        ...
        test("status 400 query of sort_by a column that does not exist", () => {
            return request(app)
                ...
                .then(({ body }) => {
                    expect(body.msg).toBe(
                        "No such column in database or invalid order type"
                    );
                });
        });
    ...
    describe("POST /api/reviews/:review_id/comments", () => {
        ...
        test("status 422 failed to post due to username does not exist", () => {
            return request(app)
                ...
                .then(({ body }) => {
                    expect(body.msg).toBe(
                        "Unprocessable: username or review_id not found!"
                    );
                });
        });
        ...
        test("status 400 failed to post due to null value in username or body", () => {
            return request(app)
                ...
                .then(({ body }) => {
                    expect(body.msg).toBe(
                        "Username or post body cannot be null!"
                    );
                });
        });
    ...
    describe("DELETE /api/comments/:comment_id", () => {
        ...
        test("status 404 requested comment_to_be_deleted cannot be found", () => {
            return request(app)
                ...
                .then(({ body }) => {
                    expect(body.msg).toBe(
                        "This comment_id does not exist!"
                    );
                });
        });
